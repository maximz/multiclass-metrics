#!/usr/bin/env python
#
# multiclass_metrics documentation build configuration file, created by sphinx-quickstart.
#
...
version = multiclass_metrics.__version__
# The full version, including alpha/beta/rc tags.
release = multiclass_metrics.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(multiclass_metrics.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "multiclass_metrics/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/multiclass-metrics/blob/%s/%s" % (tag, filename)
...
html_theme_options = {
    ...
    "github_user": "maximz",
    "github_repo": "multiclass-metrics",
    "github_banner": True,
    "github_type": "star",
    "show_related": False,
    "note_bg": "#FFF59C",
...
htmlhelp_basename = "multiclass_metricsdoc"
...
latex_documents = [
    (
        master_doc,
        "multiclass_metrics.tex",
        "multiclass-metrics Documentation",
        author,
        "manual",
    ),
]
